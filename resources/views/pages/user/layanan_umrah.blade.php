            ...
            <div class="col-md-4">
                <div class="card shadow-sm">
                    <div class="card-img-top position-relative">
                        <img src="{{asset('images/Umroh.jpg')}}" class="img-fluid rounded-top" alt="Haji Furada">
                    ...
                    <div class="card-body">
                        <h6 class="fw-bold text-center">Umrah Paket Bintang Lima</h6>
                        <hr>
                        ...
                        <p class="fw-nomal text-dark ">Harga Mulai Dari: <br><span
                                class="fw-bolder fs-5 text-warning">$1.500</span><br></p>

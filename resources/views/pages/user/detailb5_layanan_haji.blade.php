...
@section('style')
    @vite(['resources/css/user/detailb5_layanan_haji.css'])
@endsection
        ...
        <div class="row mt-5 bg-white p-4 rounded">
            <div class="col-md-8">
                ...
                <div class="container header-container mt-4">
                    <img src="{{asset('images/DetailB5.png')}}" class="header-image" alt="Haji Furoda">
                </div>
            </div>
            ...
            <div class="container info-box">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <p><i class="bi bi-geo-alt-fill custom-icon fs-4"></i> <span class="warna-text">Swissotel Al
                                Maqam Makkah</span></p>
                    ...
                    <div class="col-md-6">
                        ...
                        <p><i class="bi bi-geo-alt-fill custom-icon fs-4"></i> <span class="warna-text">Sofitel
                                Hotel</span></p>
                        <p class="star-rating fs-4">★★★★★</p>
                ...
                <div class="accordion-item">
                    ...
                    <div id="flush-collapseTwo" class="accordion-collapse collapse"
                        ...
                        <ul class="list-fasilitas">
                            <li><i class="bi bi-check-circle-fill green-icon"></i> Hotel Makkah (Pullman/Setaraf)</li>
                            <li><i class="bi bi-check-circle-fill green-icon"></i> Hotel Madinah (Taiba Front/Setaraf)
                            </li>
                            <li><i class="bi bi-check-circle-fill green-icon"></i> Hotel Transit Dekat Jamarat</li>
                            <li><i class="bi bi-check-circle-fill green-icon"></i> Pesawat Direct (Garuda/Saudia)</li>
                            <li><i class="bi bi-check-circle-fill green-icon"></i> Maktab Arafah VIP (antara 111 s.d
                                115)</li>
                            <li><i class="bi bi-check-circle-fill green-icon"></i> Bus ber-AC selama di Saudi</li>
                            <li><i class="bi bi-check-circle-fill green-icon"></i> Kereta Eksklusif Saat Armuzna</li>
                            <li><i class="bi bi-check-circle-fill green-icon"></i> Handling Bandara di Indonesia &
                                Saudi</li>
